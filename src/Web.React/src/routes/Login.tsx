            ...
            <div className="flex flex-col gap-3">
              {providers.map((p) => (
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 rounded-xl px-7 py-3.5 border border-cream-shadow text-ink font-display font-semibold text-[0.95rem] leading-none hover:border-paprika hover:text-paprika transition-colors"
                >
                  {p.displayName}
                </a>
              ))}
